...
public class MainPageActivity extends AppCompatActivity implements MainPageContract.View{
    ...
    public void setUserProfile(UserProfile userProfile) {
        ...
        Integer badPoints = userProfile.getBadPoint();
        Integer goodPoints = userProfile.getGoodPoint();
        ...
        bad_points.setText(badPoints.toString());
        good_points.setText(goodPoints.toString());
    }
    ...
    public String getUserName() {
        SharedPreferences token = getSharedPreferences("UserToken", MODE_PRIVATE);
        return token.getString("User", "null");
    }
    ...
    public void setNewUserToken(UserToken newUserToken) {
        ...
        editor.putString("User", newUserToken.getUser());
        editor.apply();
    }
}
